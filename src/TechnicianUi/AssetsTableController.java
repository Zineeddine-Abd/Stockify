...
public class AssetsTableController implements Initializable{
	...
	public void initAssets() {
		...
		((TechnicianController)Helper.currentTechnicianLoader.getController()).getDashboardViewController().setItems(); 
    };
	...
	public void reportAsset(MouseEvent event , Asset item) {
		...
		try {
			TechnicianController.currentReportPopupLoader = new FXMLLoader(getClass().getResource(TechnicianController.fxmlReport));
			root = TechnicianController.currentReportPopupLoader.load();
			ReportPopupController controller = (ReportPopupController)TechnicianController.currentReportPopupLoader.getController();
	...
	public void showMessagesList(MouseEvent event ,Asset asset) {
		...
		try {
			TechnicianController.currentMessagesLoader = new FXMLLoader(getClass().getResource(TechnicianController.fxmlMessages));
			root = TechnicianController.currentMessagesLoader.load();
			MessageController controller = (MessageController)TechnicianController.currentMessagesLoader.getController();
    ...
    public void updateAsset(Asset oldAsset, Asset newAsset) {
    	ObservableList<Action> recentActions = ((TechnicianController)Helper.currentTechnicianLoader.getController()).getDashboardViewController().getrecentActionsObsList();
