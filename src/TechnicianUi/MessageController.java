...
public class MessageController {
	...
	public void setItems() {
		try {
			messagesList = ((TechnicianController)Helper.currentTechnicianLoader.getController()).getMessagesList();
	...
	public void showReportDetails(MouseEvent event ,Message item) {
		Parent root;
		try {
			TechnicianController.currentReportDetailsPopupLoader = new FXMLLoader(getClass().getResource(TechnicianController.fxmlReportDetails));
			root = TechnicianController.currentReportDetailsPopupLoader.load();//this is the problem.
			ReportDetailsPopupController controller = (ReportDetailsPopupController)TechnicianController.currentReportDetailsPopupLoader.getController();
