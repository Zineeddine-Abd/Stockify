...
public class MessageController {
	...
	public void setItems() {
		try {
			messagesList = ((ProfessorController)Helper.currentProfessorLoader.getController()).getMessagesList();
	...
	public void showReportDetails(MouseEvent event ,Message item) {
		Parent root;
		try {
			ProfessorController.currentReportDetailsPopupLoader = new FXMLLoader(getClass().getResource(ProfessorController.fxmlReportDetails));
			root = ProfessorController.currentReportDetailsPopupLoader.load();//this is the problem.
			ReportDetailsPopupController controller = (ReportDetailsPopupController)ProfessorController.currentReportDetailsPopupLoader.getController();
