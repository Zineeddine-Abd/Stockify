...
public class HardwaresController implements Initializable{
	//table view components (HARDWaRE)
	@FXML
	private TableColumn<String, Hardware> hardwareStatusColumn;
	@FXML
	private TableColumn<String, Hardware> hardwareRoomColumn;
	@FXML
	private TableColumn<String, Hardware> hardwareAssetReferenceColumn;
